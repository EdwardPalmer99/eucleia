...
{
	BoolNode(bool state) : boolValue{state} {}
	~BoolNode() override {}
	
	inline NodeType type() const override { return NodeType::Bool; }
...
{
	StringNode(std::string & string) : stringValue{string} {}
	~StringNode() override {}
...
{
	VariableNameNode(std::string & name) : variableName{name} {}
	~VariableNameNode() override {}
	
	inline NodeType type() const override { return NodeType::VariableName; }
...
struct VariableNode : VariableNameNode
{
	...
	inline NodeType type() const override { return NodeType::Variable; }
...
{
	IntNode(long number) : numberValue{number} {}
	~IntNode() override {}
	
	inline NodeType type() const override { return NodeType::Int; }
...
{
	FloatNode(double number) : numberValue{number} {}
	~FloatNode() override {}
	
	inline NodeType type() const override { return NodeType::Float; }
...
{
	ProgramNode(std::vector<SharedNode> _nodes) : nodes{std::move(_nodes)}  {}
	~ProgramNode() override {}
	
	inline NodeType type() const override { return NodeType::Program; }
...
{
	ArrayNode(std::vector<SharedNode> _nodes) : ProgramNode(_nodes) {}
	ArrayNode(ProgramNode & _program) : ProgramNode(std::move(_program)) {}
...
struct ArrayAccessNode : BaseNode
{
	...
	inline NodeType type() const override { return NodeType::ArrayAccess; }
...
struct IfNode : BaseNode
{
	...
	inline NodeType type() const override { return NodeType::If; }
...
struct DoWhileNode : BaseNode
{
	...
	inline NodeType type() const override { return NodeType::DoWhile; }
...
struct WhileNode : DoWhileNode
{
	...
	inline NodeType type() const override { return NodeType::While; }
};
...
struct ForLoopNode : BaseNode
{
	...
	inline NodeType type() const override { return NodeType::ForLoop; }
...
struct FunctionCallNode : BaseNode
{
	...
	inline NodeType type() const override { return NodeType::FunctionCall; }
...
struct FunctionNode : FunctionCallNode, public std::enable_shared_from_this<FunctionNode>
{
	...
	inline NodeType type() const override { return NodeType::Function; }
	
	std::shared_ptr<FunctionNode> getShared() { return shared_from_this(); }
...
struct BreakNode : BaseNode
{
	...
	inline NodeType type() const override { return NodeType::Break; }
...
struct ReturnNode : BaseNode
{
	...
	inline NodeType type() const override { return NodeType::Return; }
...
struct AssignNode : BaseNode
{
	...
	inline NodeType type() const override { return NodeType::Assignment; }
...
struct BinaryNode : AssignNode
{
	...
	inline NodeType type() const override { return NodeType::Binary; }
